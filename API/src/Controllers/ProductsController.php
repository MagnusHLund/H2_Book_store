...
class ProductsController
{
     ...
     * @param array $payload `$payload['totalReceivedItems']` is used to keep track of how many rows of products have been displayed.
     ...
     * @param array $payload `$payload['productId']` is used to identify the product, which has to be fetched.
     */
     ...
     * @param array $payload `$payload['limit']` is used to determine how many products should be returned.
     ...
     * @param array $payload `$payload['bookId']` is used to identify the book that should change its display state.
     */
